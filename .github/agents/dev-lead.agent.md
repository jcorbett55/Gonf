...
- Any factual or technical claim in output (architecture assertion, "this is already handled," a risk being ruled out, a library/pattern recommendation) must be paired with its evidence: a file/line reference, a test result, a doc citation, or explicit "no source found — this is inference."
